  ...
  return (
    <div className="responsive w-full">
      ...
      <div id="projects" className=" responsive container pb-20 mx-auto">
        <h2 className="text-4xl font-bold  text-contrast text-center mt-10">
          My Projects
        </h2>
        <p className="text-center text-gray-600 mx-4 text-xl mt-2">
      ...
      <div id="skills" className=" responsive pb-20 container mx-auto">
        <h2 className="text-4xl  text-contrast font-bold text-center mt-10">
          My Skills
        </h2>
